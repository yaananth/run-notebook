...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield exec.exec('sudo python -m pip install papermill ipykernel nbformat nbconvert');
            // Execute notebook
            const pythonCode = `
    ...
    `;
            yield exec.exec(`sudo python -c ${pythonCode}`);
            // Convert to HTML
            yield exec.exec(`jupyter nbconvert ${parsedNotebookPath} --to html`);
        }
        catch (error) {
