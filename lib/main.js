    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (fs.existsSync(condaEnvironmentFile)) {
                yield exec.exec(`conda env update -n ${condaEnv} --file ${condaEnvironmentFile}`);
            }
            // Install dependencies
            yield exec.exec('pip install --upgrade setuptools');
            yield exec.exec('conda install -c conda-forge -n ${condaEnv} papermill ipykernel nbformat');
